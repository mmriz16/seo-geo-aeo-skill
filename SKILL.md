...
| `check_analytics_presence.py` | 450 | Detects GA4, UA, GTM, GSC, Meta Pixel via HTML + DNS TXT |
| `generate_score_report.py` | 670 | Aggregates all checks → ROSTIDO-SCORE HTML dashboard with Framer-inspired dark design, gradient score card, Next.js/JSON-LD code solutions |
